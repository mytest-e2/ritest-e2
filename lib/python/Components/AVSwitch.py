...
def InitAVSwitch():
	...
	config.av.osd_alpha = ConfigSlider(default=255, increment = 5, limits=(20,255)) # Make Opendroid compatible with some plugins who still use config.av.osd_alpha
